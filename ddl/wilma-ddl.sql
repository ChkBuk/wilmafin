...
BEGIN
    IF :NEW.customer_id IS NULL THEN
        :NEW.customer_id := 'CUST' || customer_num_seq.NEXTVAL;
    END IF;
END;
/
...
/
   ...
   CREATE SEQUENCE  "CUSTOMER_NUM_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101667 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
