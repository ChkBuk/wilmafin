prompt --application/shared_components/user_interface/templates/list/wm_side_navigation_menu
begin
--   Manifest
--     REGION TEMPLATE: WM_SIDE_NAVIGATION_MENU
--   Manifest End
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(25293735804829919)
...
'  </div>',
'</li>'))
,p_list_template_name=>'WM Side Navigation Menu'
,p_internal_name=>'WM_SIDE_NAVIGATION_MENU'
...
,p_preset_template_options=>'t-TreeNav--styleB:js-navCollapsed--hidden'
